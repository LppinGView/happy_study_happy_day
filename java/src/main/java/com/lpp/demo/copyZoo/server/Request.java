...
import com.lpp.demo.copyZoo.server.common.Time;
import com.lpp.demo.copyZoo.zookeeper.data.Id;
import com.lpp.demo.copyZoo.zookeeper.txn.TxnDigest;
import com.lpp.demo.copyZoo.zookeeper.txn.TxnHeader;
import static com.lpp.demo.copyZoo.server.ZooDefs.*;
...
public class Request {
    ...
    public Request(NIOServerCnxn cnxn, long sessionId, int xid, int type, RequestRecord request, List<Id> authInfo) {
        this.cnxn = cnxn;
    ...
    public final NIOServerCnxn cnxn;
...
//    public QuorumVerifier qv = null;
    ...
    public boolean isThrottlable() {
        return this.type != ZooDefs.OpCode.ping
                && this.type != ZooDefs.OpCode.closeSession
    ...
    public NIOServerCnxn getConnection() {
        return cnxn;
    }
