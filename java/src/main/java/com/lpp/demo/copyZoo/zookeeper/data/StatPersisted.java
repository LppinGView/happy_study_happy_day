...
package com.lpp.demo.copyZoo.zookeeper.data;
...
public class StatPersisted implements Record {
  ...
  public int hashCode() {
    int result = 17;
    int ret;
    ret = Long.hashCode(czxid);
    result = 37*result + ret;
    ret = Long.hashCode(mzxid);
    result = 37*result + ret;
    ret = Long.hashCode(ctime);
    result = 37*result + ret;
    ret = Long.hashCode(mtime);
    result = 37*result + ret;
    ret = (int)version;
    result = 37*result + ret;
    ret = (int)cversion;
    ...
    ret = (int)aversion;
    result = 37*result + ret;
    ret = Long.hashCode(ephemeralOwner);
    result = 37*result + ret;
    ret = Long.hashCode(pzxid);
    result = 37*result + ret;
    return result;
  }
